...
public class ReportTest {
    ...
    public void testReport_abuse_report() {
        ...
        JSONObject jsonObj = new JSONObject(
                "{\"id\":1486,\"campaign_id\": \"42694e9e57\",\"list_id\":\"a70b3a068a\",\"email_id\":\"1986e2ad5e507dd4cd5b91a6058837d4\",\"email_address\":\"mr.test@gmail.com\",\"merge_fields\":{\"FNAME\":\"John\",\"LNAME\":\"Smith\",\"ADDRESS\":\"123 Mocking Bird Ln\",\"PHONE\":\"555-1234\"},\"vip\":true,\"date\":\"2019-04-04T23:39:59+00:00\",\"_links\":[]}");
    ...
    public void testReport_OpenReport_Member() {
        ...
        JSONObject jsonObj = new JSONObject(
                "{\"campaign_id\":\"f32bbb4333\",\"list_id\":\"dbbcce6ad3\",\"list_is_active\":true,\"contact_status\":\"subscribed\",\"email_id\":\"53b9e632ccb57cc123f2d2d04f9440aa\",\"email_address\":\"jeanne.tester@gmail.com\",\"merge_fields\":{\"FNAME\":\"Jeanne\",\"LNAME\":\"Tester\",\"ADDRESS\":\"\",\"PHONE\":\"\"},\"vip\":false,\"opens_count\":1,\"opens\":[{\"timestamp\":\"2019-11-05T01:48:56+00:00\"}],\"_links\":[]}");
    ...
    public void testReport_advice_report() {
        ...
        JSONObject jsonObj = new JSONObject(
                "{\"type\":\"advice-neutralstat\",\"message\":\"Your open rate was <strong>32%</strong> higher than your industry average, but <strong>-43.3%</strong> lower than this list's average.\"}");
        AdviceReport advice = new AdviceReport(jsonObj);
        assertEquals("advice-neutralstat", advice.getType());
        assertEquals("Your open rate was <strong>32%</strong> higher than your industry average, but <strong>-43.3%</strong> lower than this list's average.",
                     advice.getMessage());
    }
    ...
    public void testReport_EcommerceProductActivity() {
        ...
        JSONObject jsonObj = new JSONObject(
                "{\"title\":\"Snacks\",\"sku\":\"030001\",\"image_url\":\"http://domain.com/image/030001.gif\",\"total_revenue\":10.29,\"total_purchased\":25.30,\"currency_code\":\"usd\",\"recommendation_total\":0,\"recommendation_purchased\":0,\"_links\":[]}");
