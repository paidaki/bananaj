...
public class CampaignContent {
    ...
    public void changeHTMLContent(String htmlContent) throws Exception {
        ...
        String response = getCampaign().getConnection().do_Put(
                new URL(getCampaign().getConnection().getCampaignendpoint() + "/" + this.getCampaign().getId() + "/content"), content.toString(),
                this.getCampaign().getConnection().getApikey());
