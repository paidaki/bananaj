...
//			}
    ...
    public void updateSettings(CampaignSettings campaignSettings) throws CampaignSettingsException, Exception {
        ...
        String response = getConnection().do_Patch(new URL(getConnection().getCampaignendpoint() + "/" + getId()), jsonObj.toString(),
    ...
    public Campaign resend() throws Exception {
        ...
        String results = getConnection().do_Post(new URL(getConnection().getCampaignendpoint() + "/" + getId() + "/actions/create-resend"),
                                                 getConnection().getApikey());
    ...
    public Campaign replicate() throws Exception {
        ...
        String results = getConnection().do_Post(new URL(getConnection().getCampaignendpoint() + "/" + getId() + "/actions/replicate"),
                                                 getConnection().getApikey());
        return new Campaign(getConnection(), new JSONObject(results));
    }
    ...
    public CampaignSendChecklist getSendChecklist() throws MalformedURLException, TransportException, URISyntaxException {
        ...
        String results = getConnection().do_Get(new URL(getConnection().getCampaignendpoint() + "/" + getId() + "/send-checklist"),
                                                getConnection().getApikey());
...
//	}
    ...
    private void getCampaignContent() throws JSONException, MalformedURLException, TransportException, URISyntaxException {
        ...
        JSONObject content = new JSONObject(
                getConnection().do_Get(new URL(connection.getCampaignendpoint() + "/" + this.getId() + "/content"), connection.getApikey()));
    ...
    public List<CampaignFeedback> getFeedback() throws JSONException, MalformedURLException, TransportException, URISyntaxException {
        ...
        JSONObject campaignFeedback = new JSONObject(
                getConnection().do_Get(new URL(connection.getCampaignendpoint() + "/" + this.getId() + "/feedback"), connection.getApikey()));
    ...
    public CampaignFeedback getFeedback(String feedbackId) throws JSONException, MalformedURLException, TransportException, URISyntaxException {
        ...
        JSONObject jsonObj = new JSONObject(
                getConnection().do_Get(new URL(connection.getCampaignendpoint() + "/" + getId() + "/feedback/" + feedbackId), connection.getApikey()));
