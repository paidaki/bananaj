...
public class MailChimpList {
    ...
    public List<AbuseReport> getAbuseReports(int count, int offset) throws JSONException, MalformedURLException, TransportException, URISyntaxException {
        ...
        final JSONObject list = new JSONObject(
                connection.do_Get(new URL(connection.getListendpoint() + "/" + getId() + "/abuse-reports?count=" + count + "&offset=" + offset),
    ...
    public AbuseReport getAbuseReports(int reportId) throws JSONException, MalformedURLException, TransportException, URISyntaxException {
        ...
        final JSONObject report = new JSONObject(
                connection.do_Get(new URL(connection.getListendpoint() + "/" + getId() + "/abuse-reports/" + reportId), connection.getApikey()));
...
//	}
    ...
    public List<Member> getMembers(int count, int offset) throws JSONException, MalformedURLException, TransportException, URISyntaxException {
        ...
        final JSONObject list = new JSONObject(
                getConnection().do_Get(new URL(getConnection().getListendpoint() + "/" + getId() + "/members?count=" + count + "&offset=" + offset),
                                       connection.getApikey()));
    ...
    public Member getMember(String subscriberHash) throws JSONException, MalformedURLException, TransportException, URISyntaxException {
        ...
        final JSONObject member = new JSONObject(
                getConnection().do_Get(new URL(getConnection().getListendpoint() + "/" + getId() + "/members/" + subscriberHash), connection.getApikey()));
     ...
     * @throws JSONException
     */
    public List<MemberTag> getMemberTags(String subscriberHash, int count,
                                         int offset) throws JSONException, MalformedURLException, TransportException, URISyntaxException {
     ...
     * @throws URISyntaxException
     */
    public List<MemberNote> getMemberNotes(String subscriberHash, int count,
                                           int offset) throws JSONException, MalformedURLException, TransportException, URISyntaxException {

        final JSONObject noteObj = new JSONObject(getConnection().do_Get(
                new URL(getConnection().getListendpoint() + "/" + getId() + "/members/" + subscriberHash + "/notes?count=" + count + "&offset=" + offset),
                getConnection().getApikey()));
     ...
     * @throws URISyntaxException
     */
    public List<GrowthHistory> getGrowthHistory(int count, int offset,
                                                SortDirection dir) throws JSONException, MalformedURLException, TransportException, URISyntaxException {
    ...
    public List<InterestCategory> getInterestCategories(int count, int offset)
        ...
        JSONObject list = new JSONObject(getConnection().do_Get(new URL(connection.getListendpoint() + "/" + getId()
                                                                                + "/interest-categories?count=" + count + "&offset=" + offset),
                                                                connection.getApikey()));
    ...
    public Interest getInterest(String interestCategoryId, String interestId)
        ...
        JSONObject jsonInterests = new JSONObject(connection.do_Get(new URL(connection.getListendpoint() + "/" + getId()
                                                                                    + "/interest-categories/" + interestCategoryId + "/interests/" + interestId),
                                                                    connection.getApikey()));
    ...
    public List<MergeField> getMergeFields(int count, int offset) throws MalformedURLException, JSONException, TransportException, URISyntaxException {
        ...
        URL url = new URL(
                connection.getListendpoint() + "/" + getId() + "/merge-fields?offset=" + offset + "&count=" + count); // Note: Mailchimp currently supports a maximim of 80 merge fields
