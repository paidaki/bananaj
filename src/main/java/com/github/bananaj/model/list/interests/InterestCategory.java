...
public class InterestCategory {
    ...
    public void update() throws MalformedURLException, TransportException, URISyntaxException {
        ...
        String results = connection.do_Patch(new URL(connection.getListendpoint() + "/" + getListId() + "/interest-categories/" + getId()), json.toString(),
    ...
    public Interest addInterest(Interest interest) throws JSONException, MalformedURLException, TransportException, URISyntaxException {
        ...
        String results = connection.do_Post(new URL(connection.getListendpoint() + "/" + getListId() + "/interest-categories/" + getId() + "/interests"),
    ...
    public void deleteInrest(String interestId) throws MalformedURLException, TransportException, URISyntaxException {
        ...
        connection.do_Delete(new URL(connection.getListendpoint() + "/" + getListId() + "/interest-categories/" + getId() + "/interests/" + interestId),
                             connection.getApikey());
    }
