...
public class Automation {
    ...
    public List<AutomationEmail> getEmails(int count, int offset) throws Exception {
        ...
        JSONObject jsonObj = new JSONObject(
                connection.do_Get(new URL(connection.getAutomationendpoint() + "/" + getId() + "/emails" + "?offset=" + offset + "&count=" + count),
    ...
    public AutomationEmail getEmail(String workflowEmailId) throws Exception {
        ...
        JSONObject jsonObj = new JSONObject(
                connection.do_Get(new URL(connection.getAutomationendpoint() + "/" + getId() + "/emails/" + workflowEmailId), connection.getApikey()));
