...
public class AutomationEmail {
    ...
    public AutomationSubscriberQueue getSubscriberQueue(int count, int offset) throws Exception {
        ...
        JSONObject jsonObj = new JSONObject(connection.do_Get(
                new URL(connection.getAutomationendpoint() + "/" + workflowId + "/emails/" + getId() + "/queue" + "?offset=" + offset + "&count=" + count),
    ...
    public AutomationSubscriber getSubscriber(String subscriberHash) throws Exception {
        ...
        JSONObject jsonObj = new JSONObject(
                connection.do_Get(new URL(connection.getAutomationendpoint() + "/" + workflowId + "/emails/" + getId() + "/queue/" + subscriberHash),
                                  connection.getApikey()));
    ...
    public void addSubscriber(String emailAddress) throws Exception {
        ...
        connection.do_Post(new URL(connection.getAutomationendpoint() + "/" + workflowId + "/emails/" + getId() + "/queue"), jsonObj.toString(),
                           connection.getApikey());
    ...
    public void update() throws Exception {
        ...
        String results = connection.do_Patch(new URL(connection.getAutomationendpoint() + "/" + workflowId + "/emails/" + getId()), json.toString(),
                                             connection.getApikey());
