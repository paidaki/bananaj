...
import com.github.bananaj.model.campaign.*;
...
public class MailChimpConnection extends Connection {
     ...
     * @throws JSONException
     */
    public CampaignFeedback getCampaignFeedback(String campaignID,
                                                String feedbackId) throws JSONException, MalformedURLException, TransportException, URISyntaxException {
     ...
     * @throws JSONException
     */
    CampaignFeedback createCampaignFeedback(String campaignID,
                                            String message) throws JSONException, MalformedURLException, TransportException, URISyntaxException {
     ...
     */
    public List<Report> getCampaignReports(int count, int offset, CampaignType campaignType, ZonedDateTime beforeSendTime,
                                           ZonedDateTime sinceSendTime) throws JSONException, TransportException, URISyntaxException, MalformedURLException, UnsupportedEncodingException {

        URL url = new URL(getReportsendpoint() + "?offset=" + offset + "&count=" + count +
                                  (campaignType != null ? "&type" + campaignType.toString() : "") +
                                  (beforeSendTime != null ? "&before_send_time=" + URLEncoder.encode(DateConverter.toISO8601UTC(beforeSendTime),
                                                                                                     "UTF-8") : "") +
     ...
     * @throws UnsupportedEncodingException
     */
    public OpenReport getCampaignOpenReports(int count, int offset, String campaignId,
                                             ZonedDateTime since) throws JSONException, TransportException, URISyntaxException, MalformedURLException, UnsupportedEncodingException {
     ...
     * @throws JSONException
     */
    public List<AbuseReport> getCampaignAbuseReports(int count, int offset,
                                                     String campaignId) throws MalformedURLException, JSONException, TransportException, URISyntaxException {
     ...
     * @throws JSONException
     */
    public AbuseReport getCampaignAbuseReport(String campaignId,
                                              int reportId) throws MalformedURLException, JSONException, TransportException, URISyntaxException {
     ...
     * @throws UnsupportedEncodingException
     */
    public List<AdviceReport> getCampaignAdviceReports(int count, int offset,
                                                       String campaignId) throws JSONException, TransportException, URISyntaxException, MalformedURLException, UnsupportedEncodingException {
     ...
     * @throws URISyntaxException
     */
    public List<ClickReport> getClickReports(int count, int offset,
                                             String campaignId) throws MalformedURLException, JSONException, TransportException, URISyntaxException {
     ...
     * @throws URISyntaxException
     */
    public List<ClickReportMember> getClickReportMembers(int count, int offset, String campaignId,
                                                         String linkId) throws MalformedURLException, JSONException, TransportException, URISyntaxException {
     ...
     * @throws URISyntaxException
     */
    public ClickReportMember getClickReportMember(String campaignId, String linkId,
                                                  String subscriberHash) throws MalformedURLException, JSONException, TransportException, URISyntaxException {
     ...
     * @throws URISyntaxException
     */
    public List<EcommerceProductActivity> getEcommerceProductActivity(int count, int offset, String campaignId,
                                                                      EcommerceSortField sortField) throws MalformedURLException, JSONException, TransportException, URISyntaxException {
    ...
    public List<AutomationEmail> getAutomationEmails(String workflowId, int count, int offset) throws Exception {
        ...
        JSONObject jsonObj = new JSONObject(
                do_Get(new URL(automationendpoint + "/" + workflowId + "/emails" + "?offset=" + offset + "&count=" + count), getApikey()));
        //int total_items = jsonAutomations.getInt("total_items"); 	// The total number of items matching the query regardless of pagination
